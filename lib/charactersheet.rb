class CharacterSheet
    ...
    def view
        ...
        puts "  Hit Points: #{@race.hit_points}, Speed: #{@race.speed}\n\n\n"
        @characterclass.description
        puts "Physical Description: #{@race.physical_description}"
        menu
    end

    def menu 
        puts "What else would you like to see?"
        puts "1. Detailed description of your #{@race.name} race." unless @race == nil
        puts "2. Detailed description of your #{@characterclass.name} class." unless @characterclass == nil
